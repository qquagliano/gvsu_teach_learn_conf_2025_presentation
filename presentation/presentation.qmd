...
- Are lecture slides, notes available or just "get notes from a friend"?
- Are practice activities still effective at home?

## Designing Flexible Content - A Starting Solution {#sec-flex-solution}

**Within reason, ensure that content is *mostly* available via the LMS (even the
activities)**
...
appear as expected
  ...
  relevant materials?
  - In that same vain, model using the LMS in class early on!
